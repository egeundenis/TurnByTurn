...
public class Betty extends Fighter {
    ...
    void superAbility(Fighter enemy) {
        ...
        for(int i = 0; i < this.cloneCount; i++) {   	
        	Fighter temp = enemy.newInstance();
        	temp.enemy = enemy;
	...
	public String getExplanation() {
		StringBuilder sb = new StringBuilder();
		 sb.append("Betty is an unoriginal fighter... She just throws magic sand from her pockets and "
